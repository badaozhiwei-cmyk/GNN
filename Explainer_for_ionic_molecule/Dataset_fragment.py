...
class IL_set(torch.utils.data.Dataset):
    ...
    def __init__(self,path):
        ...
        data_path = path + 'data_frag.npy'
        label_path = path + 'label_frag.npy'
    ...
    def __getitem__(self, idx):
        ...
        anion = self.data[idx][2]
        T = self.data[idx][3]
        P = self.data[idx][4]
        frag_dict = self.data[idx][1]
        b_num = self.data[idx][5]
        # ani_mol = self.data[idx][6]
        # # debug
        # print("cation",cation)
        # print("anion",anion)
        ...
        return Combine_Graph,condition,label,frag_dict,b_num
