...
gcn_explain_v2.py
===================================================
制冷剂-离子液体三图体系 单分子结构重要性热力图可视化 (V2) - GCN专版
...
使用示例：
  python gcn_explain_v2.py --sample_idx 100 --model_path ../GNN_for_property_prediction/checkpoints_v2/best_gcn_seed_1.pth
"""
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='制冷剂体系单样本 GCN-Explainer 结构热力图分析 V2')
    parser.add_argument('--sample_idx', type=int, default=100, help='需要分析的样本索引，范围 0~4443')
    parser.add_argument('--model_path', type=str, required=True, help='GCN 的权重路径，例如 ../GNN_for_property_prediction/checkpoints_v2/best_gcn_seed_1.pth')
